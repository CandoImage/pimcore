            ...
            ->children()
                ...
                ->children()
                    ->scalarNode('preview_image_thumbnail')
                        ->defaultNull()
                        ->end()
                    ->integerNode('preview_image_thumbnail_thread_limit')
                        ->defaultValue(5)
                        ->info('Defines how many preview images in parallel will be generated.')
                        ->end()
                    ->integerNode('preview_image_thumbnail_locking_timeout')
                        ->defaultValue(20)
                        ->info('Time in seconds the preview generator will wait to attempt and get a lock to generate a preview image.')
                        ->end()
