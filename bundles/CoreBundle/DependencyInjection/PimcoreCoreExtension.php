...
final class PimcoreCoreExtension extends ConfigurableExtension implements PrependExtensionInterface
{
    ...
    public function loadInternal(array $config, ContainerBuilder $container)
    {
        ...
        $container->setParameter('pimcore.maintenance.cleanup_directory.cleanup_tmp_files_atime_older_than', $config['maintenance']['cleanup_directory']['cleanup_tmp_files_atime_older_than']);
